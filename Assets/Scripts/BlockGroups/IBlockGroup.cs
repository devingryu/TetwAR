...
namespace TAR
{
    public class IBlockGroup : FloatBlockGroup
    {
        ...
        protected override Vector3Int[] InitCoords {get;set;} = new Vector3Int[]{new(0,-2,0),new(0,-1,0),new(0,0,0),new(0,1,0),};
        protected override Vector3Int CenterPos {get;set;} = new(3,2,3);
